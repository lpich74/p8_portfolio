...
export default function Home() {
   ...
   return (
      <Box component={'main'} display={'flex'} flexDirection={{xs: 'column', md: 'column'}}>
         <Box display={'flex'} flexDirection={{xs: 'column', md: 'row'}} alignItems={'center'}
            ...
            <Box  display={'flex'} flexDirection={'column'} alignItems={'center'}
                  ...
                  <a style={{fontSize: '1.3em'}} 
                     target='_blank'
                     rel='noreferrer'
                     href='https://drive.google.com/file/d/10ocivDCWx-jQfjluf9aHgDLRmozFkkeU/view?pli=1'>
                     View my résumé
                  </a>
            </Box>
         </Box>
         <Box  display={'flex'} flexDirection={'column'} justifyContent={'center'} alignItems={{xs: 'unset', md: 'center'}}
               ml={{xs:'20%', md: 0}} mr={{xs:'20%', md: 0}}
         >
         <ContactForm />
         </Box>
      </Box>
